                    ...
                    <div class="navbar-default" role="navigation">
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown ttmenu-full"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Tags <b class="dropme"></b></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                        <div class="ttmenu-content">
                                            <div class="row">
                                                @foreach ($tags as $tag)
                                                   <span class="menu-tags"><a href="/tag/{{$tag->tag}}">{{$tag->tag}}</a></span>
                                                @endforeach
                                            </div><!-- end row -->
